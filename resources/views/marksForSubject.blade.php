        ...
        <div class="container">
            <div class="row">
                <div style="width: 95%; height:7em;padding-top: 20px"   class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h3 class="display-5" >Marks For <b style="color: #9f0707">{{$subject->name}}</b></h3>
                        <p class="lead"> These are the Marks all for this subject properly organized</p>
                    </div>
                </div>
                <h4 style="color: rgb(32, 108, 3)">success percent: <b >{{ $sucssesMarks }} % </b>
                </h4>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <h4 style="color: rgb(164, 0, 0)">failure percent: <b >{{ $failMarks }} %</b>
                </h4>
                <div class="col">
        ...
        <div>
            ...
            <a style="width: 10em" class="nav-link" data-bs-toggle="modal" data-bs-target="#addServiceModel">
                <button style="width: 20em" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add
                    New marks For This subject</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;@endif
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    @if (Auth::user()->role == 4 )
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add New MARK</h5>
                    ...
                    <div class="modal-body">
                        <form id="EmployeeForm">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlInput1">TheMark</label>
                                <input type="number" name="theMark" class="form-control" placeholder="0 to 100">
                                <span class="text-danger" id="nameError"></span>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Student Name</label><br>
                                <select class="form-control" name="student_id" id="service_id_todo">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control"    name="semesterSession"   id="aa">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="deleteModel" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form action="{{ url('deleteMark') }}" method="POST">
                                                        @csrf
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteModel">Delete A Mark!
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <input type="hidden" name='Mark_delete_id'
                                                                id="lead_id">
                                                            <h5><b>Are you sure you want to delete this Mark ?</b></h5>
