                ...
                <div style="width: 95%; height:7em;padding-top: 20px" class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <div class="row">&nbsp;&nbsp;
                            ...
                            @if (Auth::user()->role == 4)
                                <div>
                                    <h3 class="display-5">Student Marks <b style="color: #9f0707">{{ $student->name }} </b>
                                    </h3>
                                    <p class="lead"> These are the Marks all for this Student properly organized</p>
                                </div>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div>
                            @endif
                            @if (Auth::user()->role == 1)
                                <div>
                                    <h3 class="display-5">All Marks  </b>
                                    </h3>
                                    <p class="lead"> These are the All Marks properly organized</p>
                                </div>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <div>
                            @endif
                            @if ($counterWithPercent < 60)
                                <h5 class="display-5">rate : <b style="color: #ff3838">{{ $counterWithPercent }} !</b>
                                </h5>
                            @elseif ($counterWithPercent >= 60 && $counterWithPercent <= 65)
                                <h5 class="display-5">rate : <b style="color: #9f0707">{{ $counterWithPercent }}</b>
                                </h5>
                            @elseif ($counterWithPercent > 65 && $counterWithPercent <= 75)
                                <h5 class="display-5">rate : <b style="color: #2174d2">{{ $counterWithPercent }}</b>
                                </h5>
                            @elseif ($counterWithPercent > 75 && $counterWithPercent <= 85)
                                <h5 class="display-5"> rate : <b style="color: #079f1e">{{ $counterWithPercent }}</b>
                                </h5>
                            @else
                                <h5 class="display-5">rate : <b style="color: #cfc803">{{ $counterWithPercent }}</b>
                                </h5>
                            @endif
                        </div>
                    </div>
                    ...
                    <table class="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col">theMark</th>
                                <th scope="col">semesterSession</th>
                        ...
                        <tbody id="myTable">
                            ...
                            @foreach ($marks as $item)
                                <tr>
                                    ...
                                    @if ($item->theMark < 60)
                                        <td style="color: red">{{ $item->subjects->name }}</td>
                                        <td style="color: red">{{ $item->theMark }}</td>
                                        <td style="color: red">{{ $item->semesterSession }}</td>
                                        <td>
                                            <a style="color:red" class="fas  fa fa-circle"></a>
                                        </td>
                                    @else
                                        <td>{{ $item->subjects->name }}</td>
                                        <td>{{ $item->theMark }}</td>
                                        <td>{{ $item->semesterSession }}</td>
                                        <td>
                                            <a style="color:rgb(0, 212, 60)" class="fas  fa fa-circle"></a>
                                        </td>
                                    @endif
