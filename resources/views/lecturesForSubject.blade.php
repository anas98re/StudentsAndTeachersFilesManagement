            ...
            <div class="row">
                <div class="col">
                    <div style="width: 95%; height:7em;padding-top: 20px"   class="jumbotron jumbotron-fluid">
                        <div class="container">
                        <h3 class="display-5" >Lectures For <b style="color: #9f0707">{{$subject->name}}</b></h3>
                        <p class="lead"> These are the lectures all for this subject properly organized</p>
                        </div>
                    </div>
                </div>
        ...
        <div>
            ...
            <a style="width: 10em" class="nav-link" data-bs-toggle="modal" data-bs-target="#addServiceModel">
                <button style="width: 20em" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add
                    New Lecture For This Subject</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    @endif
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="modal-body">
                        <form id="EmployeeForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="LinkForDownloade" class="form-control" id="exampleFormControlInput1" placeholder="https://example.com"
                                 size="30">
                    ...
                    <table class="table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col"><a>LinkForDownloade</a></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            href="{{ route('LectureFiles', ['id' => $item->id]) }}">Show Files
                                        </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="row">
                                            <a class="btn btn-warning"
                                            href="{{ route('LectureHomeWorks', ['id' => $item->id]) }}">Show HomeWorkes
                                        </a>&nbsp;&nbsp;
                                        @if (Auth::user()->role == 3)
                                            <a class="btn btn-secondary" href="{{ route('LectureEdit', ['id' => $item->id]) }}">Edit </a>&emsp;&emsp;
                                        ...
                                        <div class="modal fade" id="deleteModel" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form action="{{ url('subjectShow/deleteLecture') }}" method="POST">
                                                        @csrf
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <input type="hidden" name='Lecture_delete_id'
                                                                id="lead_id">
                                                            <h5><b>Are you sure you want to delete this Lecture ?</b></h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong><b style="color: #229ED9">keyword:</b></strong> <span
                    ...
                    <p><strong><b style="color: #229ED9">supervisored:</b></strong> <span id="Service-supervisored"></span>
                    </p>
                    <p><strong><b style="color: #229ED9">type:</b></strong> <span id="Service-type"></span>
                    </p>
                    <p><strong><b style="color: #229ED9">speailiazation:</b></strong> <span id="Service-speailiazation"></span>
                    </p>
                    <p><strong><b style="color: #229ED9">studentName:</b></strong> <span id="Service-studentName"></span>
                    </p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
