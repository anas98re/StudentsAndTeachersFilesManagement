            ...
            <div class="row">
                <div class="col">
                    <div style="width: 95%; height:7em;padding-top: 20px"   class="jumbotron jumbotron-fluid">
                        <div class="container">
                        <h3 class="display-4" >Files For <b style="color: #9f0707">{{$lecture->name}}</b></h3>
                        <p class="lead"> These are the Files all for this lecture properly organized</p>
                    </div>
                </div>
        ...
        <div>
            ...
            <a style="width: 10em" class="nav-link" data-bs-toggle="modal" data-bs-target="#addServiceModel">
                <button style="width: 20em" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add
                    New file For This Lecture</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    @endif
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div style="padding-top:0.5em"><a class="btn btn-primary" style="height: 2.4em;"  href="{{ route('subjectShow', ['id' => $lecture->subject_id]) }}" role="button">back</a></div>
            </div>
                    ...
                    <div class="modal-body">
                        <form id="EmployeeForm">
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="hidden" name="lecture_id" value="{{ $lecture->id }}" class="form-control">
                            ...
                            @foreach ($files as $item)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            @if (Auth::user()->role == 3)
                                            <a class="btn btn-secondary" href="{{ route('LectureFileEdit', ['id' => $item->id]) }}">Edit </a>&emsp;&emsp;
                                        ...
                                        <div class="modal fade" id="deleteModel" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form action="{{ url('LectureFiles/deleteFile') }}" method="POST">
                                                        @csrf
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <input type="hidden" name='File_delete_id'
                                                                id="lead_id">
