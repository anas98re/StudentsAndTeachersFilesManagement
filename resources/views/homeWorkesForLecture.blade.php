            ...
            <div class="row">
                <div class="col">
                    <div style="width: 95%; height:7em;padding-top: 20px" class="jumbotron jumbotron-fluid">
                        <div class="container">
                            <h3 class="display-5">HomeWorkes For <b style="color: #9f0707">{{ $lecture->name }}</b></h3>
                            <p class="lead"> These are the homeworkes all for this lecture properly organized</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                @if (Auth::user()->role == 3)
                    ...
                    <div style="padding-top:0.5em"><a class="btn btn-primary" style="height: 2.4em;"
                            href="{{ route('subjectShow', ['id' => $lecture->subject_id]) }}" role="button">back</a></div>
                @endif
            </div>
            <div class="row">
                @if (Auth::user()->role == 4)
                    <a style="width: 10em" class="nav-link" data-bs-toggle="modal" data-bs-target="#addHomeWorkModel">
                        <button style="width: 15em" class="btn btn-primary"><i class="fa fa-plus-circle"></i> upload
                            HomeWork</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <form id="EmployeeForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="LinkForDownloade" class="form-control"
                                    id="exampleFormControlInput1" placeholder="https://example.com"
                                    size="30">
                                        ...
                                        <div class="row">
                                            @if (Auth::user()->role == 3)
                                                <a class="btn btn-secondary"
                                                    href="{{ route('LectureHomeWorkEdit', ['id' => $item->id]) }}">Edit
                                                </a>&emsp;&emsp;

                                                <a class="btn btn-outline-success"
                                                    href="{{ route('ShowTheHomeWorks', ['id' => $item->id]) }}">Show The
                                                    HomeWorks That Upload Students
                                                </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            @if (Auth::user()->role == 4)
                                                {{-- <a style="width: 10em" class="nav-link" data-bs-toggle="modal" data-bs-target="#addHomeWorkModel">
                                                <button style="width: 15em" class="btn btn-primary"><i class="fa fa-plus-circle"></i> upload HomeWork</button></a> --}}
